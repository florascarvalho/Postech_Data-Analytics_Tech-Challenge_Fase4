...
# Exibindo a imagem
st.image(image_url, caption="Análise do Preço do Petróleo - Visão Geral", use_container_width =True)
...
# Exibindo a imagem
st.image(image_url_2, caption="Análise do Preço do Petróleo - Filtro de ano", use_container_width =True)
...
# Exibindo a imagem
st.image(image_url_3, caption="Análise do Preço do Petróleo - Filtro por Evento", use_container_width =True)
...
# Exibindo a imagem
st.image(image_url_4, caption="Amostra de Eventos considerados", use_container_width =True)
